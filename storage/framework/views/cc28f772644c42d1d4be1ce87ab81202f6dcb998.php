								...
								<?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo e(route('product.update',$product->id)); ?>" class="btn btn-danger" >
												<?php echo app('translator')->get('lang.Disable'); ?>
											</a>

											<?php else: ?>
												<a href="<?php echo e(route('product.update',$product->id)); ?>" class="btn btn-success" >
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/p0q611oukaju/public_html/organizations/resources/views/admin/product/index.blade.php ENDPATH**/ ?>