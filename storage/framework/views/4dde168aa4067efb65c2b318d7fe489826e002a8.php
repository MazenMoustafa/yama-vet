	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-body">
					<form class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data" action="<?php echo e(route('seller.product.store')); ?>">
                        <?php echo csrf_field(); ?>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								...
								<input class="form-control" id="validationCustom04" type="number" placeholder="<?php echo app('translator')->get('lang.quantity'); ?>" name="quantity" value="<?php echo e(old('quantity')); ?>" required="" min=1>
...
<?php echo $__env->make('seller.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/p0q611oukaju/public_html/organizations/resources/views/seller/product/add.blade.php ENDPATH**/ ?>