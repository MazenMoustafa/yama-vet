							...
							<tbody>
								<?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
									<tr>
										...
										<td>
											<a href="<?php echo e(route('seller.order.details',$order->id)); ?>" class="btn btn-primary" ><?php echo app('translator')->get('lang.details'); ?></a>
											<?php if($order->file): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('seller.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/p0q611oukaju/public_html/organizations/resources/views/seller/order/index.blade.php ENDPATH**/ ?>