...
<h3> <?php echo app('translator')->get('lang.edit_Seller'); ?></h3>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb-items'); ?>
<li class="breadcrumb-item"><?php echo app('translator')->get('lang.Sellers'); ?></li>
<li class="breadcrumb-item active"> <?php echo app('translator')->get('lang.edit_Seller'); ?></li>
<?php $__env->stopSection(); ?>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-body">
					<form class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data" action="<?php echo e(route('seller.update',$seller->id)); ?>">
                        <?php echo csrf_field(); ?>
						<?php echo method_field("PUT"); ?>
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="validationCustom01"><?php echo app('translator')->get('lang.Name'); ?></label>
								<input class="form-control" id="validationCustom01" type="text" name="name" value="<?php echo e($seller->name); ?>" placeholder="name" required="">
							...
							<div class="col-md-6 mb-3">
								...
								<input class="form-control" id="validationCustom02" type="text" name="email"  value="<?php echo e($seller->email); ?>"  placeholder="email" required="">
								<div class="valid-feedback">Looks good!</div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01"><?php echo app('translator')->get('lang.Categories'); ?></label>
                                ...
                                <select class="js-example-placeholder-multiple col-sm-12"  id="validationCustom01"  name="categories[]" multiple="multiple" required="">
									...
									<option value="<?php echo e($category->id); ?>"  <?php if(in_array($category->id, $sellerCategories->toArray())): echo 'selected'; endif; ?>><?php echo e($category->name); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/p0q611oukaju/public_html/organizations/resources/views/admin/seller/edit.blade.php ENDPATH**/ ?>