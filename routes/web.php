...
Route::get('test88', [TestController::class, 'test'])->name('category.sss');
...
Route::group(['middleware' => ['auth:admin','CheckUserActiviation']], function(){ 
    ...
    Route::prefix('dashboard')->group(function () {
        ...
        Route::post('edit_city', [Admin\CityController::class, 'update'])->name('city.update');
        Route::delete('delete_city', [Admin\CityController::class, 'destroy'])->name('city.destroy');
        ...
        Route::post('edit_banner', [Admin\BannerController::class, 'update'])->name('banner.update');
        Route::delete('delete_banner', [Admin\BannerController::class, 'destroy'])->name('banner.destroy');
        Route::resource('slider', 'Admin\SliderController');
        Route::post('edit_slider', [Admin\SliderController::class, 'update'])->name('slider.update');
